				...
				if(explosionDamageAmt >= 1 && hit.collider ==  hitCollider){
					...
					switch(hitCollider.gameObject.layer){
						case 13://hit object is an NPC
							...
							if (hit.transform.gameObject.GetComponent<DarkTreeFPS.NPC>())
							{
								hit.transform.gameObject.GetComponent<DarkTreeFPS.NPC>().GetHit(1000);
							}


							if (hitCollider.gameObject.layer == LayerMask.NameToLayer("Enemy"))
							{
								hitCollider.gameObject.GetComponent<DarkTreeFPS.NPC>().GetHit(1000);
							}

							if (hitCollider.gameObject.layer == LayerMask.NameToLayer("Enemy1"))
							{
								hitCollider.gameObject.GetComponent<DarkTreeFPS.NPC>().GetHit(1000);
							}

							if (hitCollider.gameObject.layer == LayerMask.NameToLayer("Enemy2"))
							{
								hitCollider.gameObject.GetComponent<DarkTreeFPS.NPC>().GetHit(1000);
							}

							if (hitCollider.gameObject.layer == LayerMask.NameToLayer("Enemy3"))
							{
								hitCollider.gameObject.GetComponent<DarkTreeFPS.NPC>().GetHit(1000);
							}

							if (hitCollider.gameObject.layer == LayerMask.NameToLayer("Enemy4"))
							{
								hitCollider.gameObject.GetComponent<DarkTreeFPS.NPC>().GetHit(1000);
							}
							break;
