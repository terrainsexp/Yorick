...
//	public bool drawCamSphere;
  ...
  public   Vector3 eulerRotation;
	...
	void Update (){
        ...
        eulerRotation = new Vector3(transform.eulerAngles.x * 0, transform.eulerAngles.y, transform.eulerAngles.z * 0);
        TPSPlayer.transform.rotation = Quaternion.Euler(eulerRotation);
        Debug.Log("Player Rotation :" + TPSPlayer.transform.rotation);
