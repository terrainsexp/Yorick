			...
			if(hit.collider){
				...
				switch(hit.collider.gameObject.layer){
					...
					case 13://hit object is an NPC
                        if (hit.collider.gameObject.GetComponent<DarkTreeFPS.NPC>())
                        {
                            hit.collider.gameObject.GetComponent<DarkTreeFPS.NPC>().GetHit(50);
                        }
                        Debug.Log("EnemyFind");
                    ...
                    case 21://hit object is player lean collider
                        if (hit.collider.gameObject.GetComponent<DarkTreeFPS.NPC>())
                        {
                            hit.collider.gameObject.GetComponent<DarkTreeFPS.NPC>().GetHit(50);
                        }
